...
export default function Miracle(props){
  ...
  <img src="images/miracle.jpeg" alt="" className="img-responsive" style={{width: '100%', height: '350px'}} />
</div>
                          ...
                          <div class="col-md-6 col-lg-4 mb-5">
                            ...
                            <div class="block-20">
                              ...
                              <figure style={{width:'100%'}}>
                                  <a href="blog-single.html"><img src={"images/" } alt="Image placeholder" class="img-fluid" /></a>
                              </figure>
