...
export default class OBES extends Component {
...
<div class="site-section block-20  bg-light">
      <div class="site-section">
        <div class="container">
          <div class="row py-5">
            
          <div class="col-md-6 mb-5 mb-md-0 aos-init">
            <div class=" embed-responsive" style={{minheight: '300px'}}>
            <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/O_u4TV5Typs" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen=""></iframe>
            </div>
