...
import logoImage from '../images/pic.png';
  ...
  <div className="wrap">
    ...
    <header role="banner">
      <nav className="navbar navbar-expand-lg navbar-light bg-light">
        <div className="container">
          <a className="navbar-brand absolute" href="http://localhost:3001" > <img src={logoImage} width="50" height="50"></img></a>
            ...
            <ul className="navbar-nav ml-auto">
              ...
              <li className="nav-item dropdown">
                ...
                <div className="dropdown-menu" aria-labelledby="dropdown04">
                  <a className="dropdown-item" href="ministry.html">Introduction</a>
                  <a className="dropdown-item" href="ministry.html">Ms.Dimple Anil</a>
              ...
              <li className="nav-item dropdown">
                ...
                <div className="dropdown-menu" aria-labelledby="dropdown05">
                  <a className="dropdown-item" href="sermon.html">Daily Prayer</a>
                  <a className="dropdown-item" href="sermon.html">Direction</a>
                  <a className="dropdown-item" href="sermon.html">Obe's</a>
        ...
        <div className="row align-items-center">
          ...
          <div className="col-md-6 order-md-1">
            <div className="block-15">
              ...
              <a href="http://godsconsciousness.com/lib/gods.mp4" class="popup-vimeo image-play" style={{float:"left"}}> <span class="icon-wrap"> <span class="icon icon-play"></span> </span> <img src="http://godsconsciousness.com/images/Aunty pics - corrected 02croped corrected.jpg"></img> </a>
              </div>
